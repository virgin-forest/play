...
class QQMailer
{
    ...
    #private static $USERNAME = 'virgin-forest@foxmail.com'; // 授权登录的账号
    private static $USERNAME = 'ip-detection@foxmail.com';
    #private static $PASSWORD = 'tiuuyeirertugjgh'; // 授权登录的密码
    private static $PASSWORD = 'wzvylqtecjgxdhdg';
    private static $NICKNAME = 'TaskMan'; // 发件人的昵称
    ...
    public function __construct($debug = false)
    {
        ...
        $this->mailer->SMTPDebug = $debug ? 0 : 1;
